...
var inFloorCenter = EnemyInFloor(collisionTiles, x, bbox_bottom + 1);
var inFloorLeft = EnemyInFloor(collisionTiles, bbox_left, bbox_bottom + 1);
var inFloorRight = EnemyInFloor(collisionTiles, bbox_right, bbox_bottom + 1);
